  ...
  <div class="form-container">
    <form id="registrationForm">
      <div class="form-step active">
        <h2 class="section-title"><i class="fas fa-user"></i> Patient Registration</h2>
        ...
        <div class="form-row">
          <div class="form-column">
            ...
            <input type="text" name="recordNumber"  class="form-control" required>
          </div>
          <div class="form-column">
...
<h3 class="section-title">Patient History</h3>
        ...
        <div class="form-row">
          <div class="form-column">
            ...
            <textarea name="medications" class="form-control">Dicyclomine (Bentyl) as needed for IBS. Probiotic supplement daily.</textarea>
          </div>
        </div> -->
