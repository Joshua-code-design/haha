Can't create, edit, or upload … Not enough storage to save to Drive, back up Google Photos, or use Gmail. Get 100 GB of storage for ₱119.00 ₱0 for 1 month.
<?php
    session_start();
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="index-1.htm">
                            <Span>welcome to gastronet</span>
                        </a>
...
while ($row = mysqli_fetch_assoc($result)) {
    echo "<tr>
        ...
        <td class='action-btns'>
            ...
            <button class='btn btn-sm btn-warning labs-btn' data-id='{$row['id']}' data-bs-toggle='modal' data-bs-target='#labResultsModal'><i class='bi bi-clipboard2-pulse'></i> Labs</button>
        </td>
    </tr>";
}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="medicationContent">
                <!-- Medication data will be loaded here via AJAX -->
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('.med-btn').click(function() {
        ...
        $.ajax({
            url: 'customer_med.php',
            type: 'GET',
            data: { patient_id: patientId },
            success: function(response) {
                $('#medicationContent').html(response);
            },
            error: function() {
                $('#medicationContent').html('<div class="alert alert-danger">Failed to load medications.</div>');
            }
        });
    });
});
